...
java -classpath /home/ubuntu/cc-grader/20A/apps/aynalemL_github/target/production/*  report.MainApplication ${TEST_OUTPUT_PATH}/input/Border_Crossing_Entry_Data.csv ${TEST_OUTPUT_PATH}//output/report.csv
