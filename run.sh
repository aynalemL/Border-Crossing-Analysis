...
ls -l
java -classpath /home/ubuntu/cc-grader/20A/apps/aynalemL_github/ccgrader_temp/target/production/*  MainApplication input/Border_Crossing_Entry_Data.csv output/report.csv
