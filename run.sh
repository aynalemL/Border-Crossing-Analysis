...
java -cp ./target/production/border-crossing-analysis-master/report/* ./target/report/MainApplication.class ./input/Border_Crossing_Entry_Data.csv ./output/report.csv
